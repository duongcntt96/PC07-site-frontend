  ...
  return (
    <main onMouseOver={(e) => dispatch(closeSubMenu())}>
      ...
      <div>
        ...
        <iframe style="width: 100%; max-width: 1120px; height: 560px; border: none;" src="https://www.youtube.com/embed/QocEbM-IhN4?si=_jE7_TMiaORTkWTu" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
